...
export function savePageContent(user, gradeSlug, subjectSlug, topicSlug, pageSlug, bodyHtml) {
  return commit(user, { action: "update-page", gradeSlug, subjectSlug, topicSlug, pageSlug, bodyHtml });
}
